...
const TextEditorV3 = ({ id, value, error, className, onChange, options = {} }) => {
    ...
    const config = useMemo(
        () => ({
            ...
            className,
            buttons: ["bold", "italic", "strikethrough", "underline", "|", "source", "|", "font", "fontsize","align", "|", "ul", "ol", "image", "link", "|", "undo", "redo"],
            ...options
        }),
        [options, className]
    );
