  ...
  const formatUserAnswers = () => {
    ...
    extraQuestions.forEach(question => {
      question.sub_question_rules?.forEach(({ sub_question }) => {
        ...
        if (sub_question.type === 'CheckBox') userAnswer = userAnswer === 'false' ? false : userAnswer ? true: false;
      ...
      if (question.type === 'CheckBox') userAnswer = userAnswer === 'false' ? false : userAnswer ? true: false;
