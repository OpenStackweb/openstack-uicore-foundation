...
class OPSessionChecker extends React.Component {
    ...
    render() {
        ...
        //console.log(`OPSessionChecker::render opFrame_src ${this.state.opFrame_src} rpCheckSessionStateFrame_src ${this.state.rpCheckSessionStateFrame_src}`);
        return(
