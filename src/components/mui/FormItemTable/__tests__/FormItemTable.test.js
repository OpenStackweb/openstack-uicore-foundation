...
describe("FormItemTable Component", () => {
  ...
  describe("Rendering", () => {
    it("renders the table with correct structure", () => {
      ...
      expect(
        screen.getByText("sponsor_edit_form.code")
      ).toBeInTheDocument();
      expect(
        screen.getByText("sponsor_edit_form.description")
      ).toBeInTheDocument();
      expect(
        screen.getByText("sponsor_edit_form.early_bird_rate")
      ).toBeInTheDocument();
      expect(
        screen.getByText("sponsor_edit_form.standard_rate")
      ).toBeInTheDocument();
      expect(
        screen.getByText("sponsor_edit_form.onsite_rate")
      ).toBeInTheDocument();
      expect(
        screen.getByText("sponsor_edit_form.qty")
      ).toBeInTheDocument();
      expect(
    ...
    it("renders TOTAL row at the bottom", () => {
      ...
      expect(
        screen.getByText("sponsor_edit_form.total_on_caps")
      ).toBeInTheDocument();
    });
  });
