...
// paginationPosition is a comma-separated string ("top", "bottom", "top,bottom",
...
const parsePaginationPosition = (paginationPosition = "top,bottom") => {
  ...
  return {
    showTop: positions.includes("top"),
    showBottom: positions.includes("bottom")
  };
};

export default parsePaginationPosition;
