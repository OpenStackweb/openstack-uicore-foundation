...
module.exports = {
    entry: {
        ...
        'components/mui/addon-type-select': './src/components/mui/addon-type-select.js',
        ...
        'components/mui/editable-table': './src/components/mui/tables/editable-table/index.js',
        'components/mui/sortable-table': './src/components/mui/tables/sortable-table/index.js',
      'components/mui/sortable-table-v2': './src/components/mui/tables/sortable-table-v2/mui-table-sortable-v2.js',
      'components/mui/bulk-edit-table': './src/components/mui/BulkEditTable/index.js',
        'components/mui/table': './src/components/mui/tables/mui-table/index.js',
        'components/mui/table/custom-table-pagination': './src/components/mui/tables/components/CustomTablePagination.js',
        'components/mui/table/extra-rows': './src/components/mui/tables/extra-rows/index.js',
        ...
        'components/mui/formik-inputs/addon-type-select': './src/components/mui/formik-inputs/mui-formik-addon-type-select.js',
